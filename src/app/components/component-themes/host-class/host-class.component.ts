...
@Component({
  selector: 'app-host-class',
  templateUrl: './host-class.component.html',
  styleUrls: ['./host-class.component.scss']
})
export class HostClassComponent implements AfterContentInit {
    themeClassNames;
    isState01 = false;
    isState02 = false;
    items = [
